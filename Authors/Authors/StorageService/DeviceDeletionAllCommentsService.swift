//
//  DeviceDeletionAllCommentsService.swift
//  Authors
//
...
protocol DeviceDeletionAllCommentsServiceProtocol {
    func deleteAllCommentsData(success: @escaping (Bool) -> (), fail: @escaping (String) -> ())
}

class DeviceDeletionAllCommentsService: DeviceDeletionAllCommentsServiceProtocol {
